      ...
      <table>
        <tr v-for="m in markets" 
          ...
          <td>
            ...
            <a v-else class="hover:underline text-green-600"
              target="_blanck"
            >{{ m.url }}</a>
          </td>
        </tr>
...
export default {
  ...
  methods: {
    ...
    getWebSite(exchange){
      ...
      .then(res => {
        // Se agrega una propiedad al sistema de reactividad de vue por que si no no la reconoce 
